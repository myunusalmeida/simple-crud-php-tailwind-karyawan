...
<body>
    <div class="max-w-7xl mx-auto py-5">
        <div class="flex justify-between items-center mb-14">
            <h1 class="text-white text-2xl font-bold">Tambah Karyawan Baru</h1>
        ...
        <form action="_action-karyawan.php" method="post">
            ...
            <div class="mb-3 grid grid-cols-2 gap-3">
                ...
                <div>
                    ...
                    <input type="text" name="tempat_lahir" placeholder="Tempat Lahir" class="input input-bordered w-full" />
                </div>
            </div>
            <div class="mb-3">
                <label for="alamat">Alamat</label>
                <textarea name="alamat" class="w-full textarea textarea-bordered" placeholder="Alamat"></textarea>
            </div>
            <div class="mb-3">
